...
export const ColumnCard = ({ column, onEdit, onDelete, onAddTask, onEditTask, onDeleteTask, className = "" }) => {
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex-1">
            <h3 className="font-medium text-gray-900 truncate">{column.titulo || column.nombre}</h3>
            <div className="flex items-center mt-1 text-sm text-gray-500">
              <span>{taskCount} tareas</span>
              {taskCount > 0 && <span className="ml-2">• {completedTasks} completadas</span>}
            </div>
          </div>
